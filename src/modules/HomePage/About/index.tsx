...
const About = (): ReactElement => {
  return (
    <div id="about" className="w-screen h-[200vh] relative">
      <CanvasLoop />
      <div className="h-screen w-full px-[2rem] lg:px-[12.1rem] py-[14.1rem] absolute top-0 left-0 overflow-hidden">
      ...
      <div className="h-screen w-full px-[2rem] lg:px-[10rem] py-[12rem] relative overflow-hidden">
        <div className="flex flex-col gap-16 w-full lg:w-[82.6rem] bg-red">
          {paragraphs.map((item) => (
